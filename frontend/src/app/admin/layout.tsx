...
const navItems = [
  ...
  { href: '/admin/attendance', label: 'Asistencia', icon: <AttendanceIcon /> },
  { href: '/admin/downloads', label: 'Descargas', icon: <DownloadsIcon /> },
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return <DashboardLayout navItems={navItems} title="Panel de administración">{children}</DashboardLayout>;
}
